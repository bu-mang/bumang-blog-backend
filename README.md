...
docker exec -it <DOCKER_DB_PROCESS> psql -U <USER_NAME> -d <DB_NAME>

# grafana

ssh -i key-of-bumang-blog.pem -L 9090:localhost:9090 -L 3001:localhost:3001 -L 3000:localhost:3000 ec2-user@13.124.254.190

# SSH 접속

ssh -i key-of-bumang-blog.pem ec2-user@ec2-13-124-254-190.ap-northeast-2.compute.amazonaws.com
